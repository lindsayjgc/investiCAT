					...
					<div className='flex w-full flex-col gap-2 px-3 py-2'>
						...
						<div className='flex w-full items-center gap-2'>
							...
							<motion.div
								...
								<EditorContent
									// editor may come from a different copy of @tiptap/core bundled under cedar-os.
									// Narrow the type to the Editor type expected by @tiptap/react to avoid
									// cross-package type mismatches from duplicate packages in node_modules.
									// This is a safe runtime no-op cast used to satisfy TypeScript.
									editor={editor as unknown as import('@tiptap/react').Editor | null}
