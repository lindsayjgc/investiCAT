...
export default {
  darkMode: ["class"],
  content: [
    './src/cedar/components/**/*.{js,ts,jsx,tsx}',"./pages/**/*.{ts,tsx}", "./components/**/*.{ts,tsx}", "./app/**/*.{ts,tsx}", "./src/**/*.{ts,tsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      colors: {
        ...
        event: {
          ...
          danger: "hsl(var(--event-danger))",
        },
        relationship: {
          highlight: "hsl(var(--relationship-highlight))",
        },
        sidebar: {
